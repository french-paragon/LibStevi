...
public:
	...
	inline StereoRigRectifier(ShapePreservingTransform<float> cam2tocam1,
										   float fLenCam1Px,
	...
	inline StereoRigRectifier(StereoRigRectifier const& other) :
	...
	inline StereoRigRectifier(StereoRigRectifier && other) :
		StereoRigRectifier(other._cam2Tocam1,
						   other._fLenCam1Px,
						   other._ppCam1,
						   other._sizeCam1,
	...
	inline StereoRigRectifier& operator=(StereoRigRectifier const& other) {
	...
	inline StereoRigRectifier& operator=(StereoRigRectifier && other) {
	...
	inline bool compute(TargetRangeSetMethod roiSetMethod, TargetRangeSetMethod resolutionSetMethod) {
	...
	inline bool computeOptimalCamsRots() {
	...
	inline Eigen::Vector2f computeForwardVec(Eigen::Vector2f const& vec,
	...
	inline Eigen::Vector2f computeBackwardVec(Eigen::Vector2f const& vec,
									   Eigen::Vector2f const& pp,
									   float f,
	...
	inline bool computeForwardMaps() {
	...
	inline bool computeROIs(TargetRangeSetMethod roiSetMethod) {
	...
	inline bool computeResolution(TargetRangeSetMethod resolutionSetMethod) {
